...
const translations: TranslationsMap = {
  en: {
    ...
    activeFieldLabel: 'Selected Field',
    selectFieldPrompt: 'Choose a field',
  ...
  mr: {
    ...
    activeFieldLabel: 'निवडलेले शेत',
    selectFieldPrompt: 'शेत निवडा',
  ...
  hi: {
    ...
    activeFieldLabel: 'चयनित खेत',
    selectFieldPrompt: 'खेत चुनें',
